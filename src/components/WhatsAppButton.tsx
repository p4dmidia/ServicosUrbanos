  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 pointer-events-none">
      <motion.a
        ...
        className="pointer-events-auto flex items-center gap-2 group bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 sm:p-4 rounded-full shadow-2xl transition-all duration-300 shadow-[#25D366]/30 relative overflow-hidden"
        ...
        transition={{ 
          ...
          stiffness: 260,
          damping: 20,
          delay: 1.5 // Delay slightly to load after page elements
        }}
